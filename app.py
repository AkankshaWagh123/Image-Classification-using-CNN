...
# Load labels
labels = pd.read_json(r"C:\Users\Akanksha\Downloads\data_1\data\class_dict_10.json")
...
def load_data():
    fv = []
    cv = []
    for folder in os.listdir(r"C:\Users\Akanksha\Downloads\data_1\data\class_10_train"):
        print(folder)
    for files in os.listdir(r"C:\Users\Akanksha\Downloads\data_1\data\class_10_train\{}\images".format(folder)):
        fv.append(cv2.imread(r"C:\Users\Akanksha\Downloads\data_1\data\class_10_train\{}\images\{}".format(folder, files)))
